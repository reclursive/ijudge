...
export const JudgesForReelection = () => {
    <div className="judgeResearchService">
      ...
      <p>With access to an extensive collection of case summaries, legal analyses, and community feedback, you're empowered to contribute to a more informed and fair electoral process. Start your research today and ensure your vote supports justice and integrity in the courtroom.</p>
    </div>
};